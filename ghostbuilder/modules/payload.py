...
MAP = {
    ...
    'windows_tcp': 'windows/meterpreter/reverse_tcp',
    'windows_https': 'windows/meterpreter/reverse_https',
    'linux_tcp': 'linux/x86/meterpreter/reverse_tcp',
    'linux_http': 'linux/x86/meterpreter_reverse_http',
